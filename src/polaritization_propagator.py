...
class Prop_pol:
    ...
    def pp_ssc_fc(self):
        '''
        property with the calculation of the FC response between 
        like a multiplication of the perturbators and the Princ Prop.
        '''
    ...
    def pp_ssc_fc_select(self,atom1,atom2):
        '''
        method with the calculation of the FC response between 
        like a multiplication of the perturbators and the Princ Prop.
        '''
    ...
    def pp_ssc_pso(self):
        '''
        property with the calculation of the PSO response between 
        like a multiplication of the perturbators and the Princ Prop.
        '''
    ...
    def pp_ssc_pso_select(self, atom1, atom2):
        '''
        method with the calculation of the PSO response between two selected atoms
        like a multiplication of the perturbators and the Princ Prop.
        '''
    ...
    def pp_ssc_fcsd(self):
        '''
        property with the calculation of the FCSD response
        like a multiplication of the perturbators and the Princ Prop.
        '''
        nvir = self.nvir
        nocc = self.nocc
    ...
    def pp_ssc_fcsd_select(self,atom1,atom2):
        '''
        property with the calculation of the FCSD response between two selected atoms
        like a multiplication of the perturbators and the Princ Prop.
        '''
        nvir = self.nvir
        nocc = self.nocc
